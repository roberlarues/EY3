...
/**
 * The ball: a sphere that rolls from cell to cell over whatever the level
 * says is free, sliding smoothly between them and turning as it goes -- the
 * rotation is worked out from the distance travelled, so the surface appears
 * to grip the floor.
 *
...
class Player : public GridObject {
	private:
		...
		Sprite ballSprite;
		Sprite winSprite;
		Mat4 roll;            // how far the ball has turned so far
